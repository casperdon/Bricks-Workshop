...
public static class ServiceCollectionExtensions
{
    ...
    {
        var builder = new NotificationLibraryOptionsBuilder(services);
        ...
        services.Add(new ServiceDescriptor(typeof(Service.NotificationService), typeof(Service.NotificationService), options.NotificationServiceLifeTime));
        services.Add(new ServiceDescriptor(typeof(INotificationService), options.NotificationServiceType, options.NotificationServiceLifeTime));
